...
public class InviteFriendFragment extends Fragment implements FriendAdapter.OnFriendClickListener {
    ...
    private void loadFriends() {
        try {
                ...
                public void onError(String error) {
                    try {
                        ...
                        new android.app.AlertDialog.Builder(requireContext())
                            .setTitle("Lỗi API")
                            .setMessage(error)
                            .setPositiveButton("Thử lại", (dialog, which) -> loadFriends())
                            .setNegativeButton("Quay lại", (dialog, which) -> requireActivity().onBackPressed())
                            .setCancelable(false)
                            .show();
                            
                    } catch (Exception e) {
                        android.util.Log.e("InviteFriendFragment", "Error showing dialog", e);
                    }
                }
            });
            ...
            new android.app.AlertDialog.Builder(requireContext())
                .setTitle("Lỗi")
                .setMessage("Có lỗi khi tải danh sách bạn bè")
                .setPositiveButton("Quay lại", (dialog, which) -> requireActivity().onBackPressed())
                .show();
        }
    }
