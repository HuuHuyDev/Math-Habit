...
public class Constants {
    ...
    // THIẾT BỊ THẬT: IP WiFi hiện tại (192.168.53.4)
    public static final String BASE_URL = "http://192.168.55.8:8080/api/";
    
    // WebSocket URL
    public static final String WS_URL = "ws://192.168.55.8:8080/api/ws";
